          ...
          <div className="flex items-start">
            ...
            <div className="flex-1">
              ...
              <p className="text-yellow-700 mb-4">
                Your organization has reached the limit of 3 notes on the free
                plan. Upgrade to Pro for unlimited notes.
              </p>
              <button
                onClick={handleUpgrade}
                disabled={upgradeInProgress}
                className="inline-flex items-center px-4 py-2 bg-green-600 hover:bg-green-700 disabled:bg-green-400 text-white font-medium rounded-lg shadow-sm transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 disabled:opacity-70 cursor-pointer"
              >
                {upgradeInProgress ? (
                  <>
                    <svg
          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="text-yellow-700">
                Your organization has reached the limit of 3 notes on the free
                plan. Please contact your administrator to upgrade to the Pro
                plan.
              </p>
            </div>
          </div>
    ...
    <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow duration-200">
      <div className="flex justify-between items-start mb-3">
        ...
        <div className="flex space-x-2 flex-shrink-0">
          <button
            onClick={onEdit}
            className="inline-flex items-center px-3 py-1 text-sm font-medium text-gray-600 hover:text-gray-800 hover:bg-gray-100 rounded-md transition-colors duration-200 cursor-pointer"
          >
            <svg
          ...
          <button
            ...
            disabled={isDeleting}
            className="inline-flex items-center px-3 py-1 text-sm font-medium text-red-600 hover:text-red-800 hover:bg-red-50 rounded-md transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
          >
            {isDeleting ? (
              <>
                <svg
